...
def determine_season():
    month = input("Enter the month of the year (e.g Jan, Feb...): ").strip().capitalize()
    day = input("Enter the day of the month (e.g 1,2,3... ): ").strip()
    day = int(day)   

    valid_months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun","Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
    if month not in valid_months:
        print("Invalid month. Please enter a valid month(e.g., Jan, Feb).")
        return
